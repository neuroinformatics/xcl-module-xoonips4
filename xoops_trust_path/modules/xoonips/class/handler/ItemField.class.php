...
class Xoonips_ItemFieldObject extends XoopsSimpleObject {
	...
	public function isDeletable() {
		...
		$gflHandler = Xoonips_Utils::getModuleHandler('ItemFieldGroupFieldLink', $this->mDirname);
		...
		$isHandler = Xoonips_Utils::getModuleHandler('ItemSort', $this->mDirname);
...
class Xoonips_ItemFieldHandler extends XoopsObjectGenericHandler {
	...
	public function delete(&$obj, $force = false) {
		...
		$qsHandler = Xoonips_Utils::getModuleHandler('ItemQuickSearchCondition', $this->mDirname);
	...
	private function _getDataTypeIdsForQuickSearch() {
		...
		$handler = Xoonips_Utils::getModuleHandler('DataType', $this->mDirname);
	...
	private function _getViewTypeIdsForQuickSearch() {
		...
		$handler = Xoonips_Utils::getModuleHandler('ViewType', $this->mDirname);
