...
$langman->set('INSTALL_ERROR_EXECUTE_CALLBACK', 'Failed to execute "{0}" callback.');
$langman->set('INSTALL_MSG_MODULE_INSTALLED', 'Module "{0}" has installed.');
$langman->set('INSTALL_ERROR_MODULE_INSTALLED', 'Module "{0}" could not be installed.');
$langman->set('INSTALL_MSG_MODULE_UNINSTALLED', 'Module "{0}" is uninstalled.');
$langman->set('INSTALL_ERROR_MODULE_UNINSTALLED', 'Module "{0}" could not be uninstalled.');
...
$langman->set('INSTALL_ERROR_UPDATE_FINISHED', 'Module could not be updated.');
$langman->set('INSTALL_MSG_MODULE_UPDATED', 'Module "{0}" is updated.');
$langman->set('INSTALL_ERROR_MODULE_UPDATED', 'Module "{0}" could not be updated.');
$langman->set('INSTALL_MSG_MODULE_INFORMATION_INSTALLED', 'Module information is installed.');
$langman->set('INSTALL_ERROR_MODULE_INFORMATION_INSTALLED', 'Module informationcould not be installed.');
$langman->set('INSTALL_MSG_MODULE_INFORMATION_DELETED', 'Module information is deleted.');
$langman->set('INSTALL_ERROR_MODULE_INFORMATION_DELETED', 'Module information could not be deleted.');
$langman->set('INSTALL_ERROR_PERM_ADMIN_SET', 'Module admin permission could not be set.');
$langman->set('INSTALL_ERROR_PERM_READ_SET', 'Module read permission could not be set.');
$langman->set('INSTALL_MSG_TPL_INSTALLED', 'Template "{0}" is installed.');
$langman->set('INSTALL_ERROR_TPL_INSTALLED', 'Template "{0}" could not be installed.');
$langman->set('INSTALL_ERROR_TPL_UNINSTALLED', 'Template "{0}" could not be uninstalled.');
$langman->set('INSTALL_MSG_BLOCK_INSTALLED', 'Block "{0}" is installed.');
$langman->set('INSTALL_ERROR_BLOCK_INSTALLED', 'Block "{0}" could not be installed.');
$langman->set('INSTALL_ERROR_BLOCK_COULD_NOT_LINK', 'Block "{0}" could not be link to module.');
$langman->set('INSTALL_ERROR_BLOCK_PERM_SET', 'Block permission of "{0}" could not be set.');
$langman->set('INSTALL_MSG_BLOCK_UNINSTALLED', 'Block "{0}" is uninstalled.');
$langman->set('INSTALL_ERROR_BLOCK_UNINSTALLED', 'Block "{0}" could not be uninstalled.');
$langman->set('INSTALL_ERROR_BLOCK_PERM_DELETE', 'Block permission of "{0}" could not be deleted.');
$langman->set('INSTALL_MSG_BLOCK_UPDATED', 'Block "{0}" is updated.');
$langman->set('INSTALL_ERROR_BLOCK_UPDATED', 'Block "{0}" could not be updated.');
$langman->set('INSTALL_MSG_BLOCK_TPL_INSTALLED', 'Block template "{0}" is installed.');
$langman->set('INSTALL_ERROR_BLOCK_TPL_INSTALLED', 'Block template "{0}" could not be installed.');
$langman->set('INSTALL_MSG_BLOCK_TPL_UNINSTALLED', 'Block template "{0}" is uninstalled.');
$langman->set('INSTALL_ERROR_BLOCK_TPL_UNINSTALLED', 'Block template "{0}" could not be uninstalled.');
$langman->set('INSTALL_MSG_CONFIG_ADDED', 'Config "{0}" is added.');
$langman->set('INSTALL_ERROR_CONFIG_ADDED', 'Config "{0}" could not be added.');
$langman->set('INSTALL_MSG_CONFIG_DELETED', 'Config "{0}" is deleted.');
$langman->set('INSTALL_ERROR_CONFIG_DELETED', 'Config "{0}" could not be deleted.');
$langman->set('INSTALL_MSG_CONFIG_UPDATED', 'Config "{0}" is updated.');
$langman->set('INSTALL_ERROR_CONFIG_UPDATED', 'Config "{0}" could not be updated.');
$langman->set('INSTALL_ERROR_CONFIG_NOT_FOUND', 'Config is not found.');
$langman->set('INSTALL_MSG_TABLE_DOROPPED', 'Table "{0}" is doropped.');
$langman->set('INSTALL_ERROR_TABLE_DOROPPED', 'Table "{0}" could not be doropped.');
$langman->set('INSTALL_MSG_TABLE_UPDATED', 'Table "{0}" is updated.');
$langman->set('INSTALL_ERROR_TABLE_UPDATED', 'Table "{0}" could not be updated.');
$langman->set('INSTALL_MSG_TABLE_ALTERED', 'Table "{0}" is altered.');
$langman->set('INSTALL_ERROR_TABLE_ALTERED', 'Table "{0}" could not be altered.');
$langman->set('INSTALL_MSG_DATA_INSERTED', 'Data are inserted to table "{0}".');
$langman->set('INSTALL_ERROR_DATA_INSERTED', 'Data could not be inserted to table "{0}".');
